...
from PIL import Image
import matplotlib.pyplot as plt
from preprocessing import samples, combine_tiles, nearest_tile_dict, project
import glob
import os
import csv

# This is the main function started

tiles_template = "/Users/moctader/Thesis/{t}/{z}/{x}/{y}.png"
zoom_level = 10
t_values = glob.glob('/Users/moctader/Thesis/landsat')
